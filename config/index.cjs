  ...
  USERS: [
    {
      ...
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'YdulP1Q9WYCy_qUltO9f4FzULdrPvDFVOcvnKjXNidM',
      // 所在省份
      province: '广西',
      // 所在城市
      city: '南宁',
      ...
      openUrl: 'http:bin.888dly.vip/A12/',
      ...
      festivals: [
        ...
        {
          type: '生日', name: '乖乖', year: '2003', date: '10-04',
        },
        {
          type: '节日', name: '表白纪念日', year: '2022', date: '03-27',
        }
      ],
